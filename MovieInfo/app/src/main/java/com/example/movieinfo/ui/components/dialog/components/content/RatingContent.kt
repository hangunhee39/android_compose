...
fun ColumnScope.StarRatingBar(score: Float) {
    Card(
        ...
        Box(
            ...
            val starBackgroundColor = MaterialTheme.colorScheme.onPrimary.copy(
                alpha = 0.2f
            ).toArgb()
            val ratingBackgroundColor = MaterialTheme.colorScheme.onPrimary.copy(
                alpha = 0.05f
            ).toArgb()
...
//                update = {
//                    inflated 될때마다 초기화 (안 사용하는 것이 좋다)
//                }
            )
        }
    }
